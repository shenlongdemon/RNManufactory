...
export default class MaterialList extends BaseScreen<Props, State> {
  ...
  private clickListItem = (item: Material, _index: number): void => {
    ...
    this.navigate(ROUTE.APP.MANUFACTORY.MATERIALS.ITEM.DEFAULT, data)
  }
  ...
  private clickAddProcess(): void {
    this.navigate(ROUTE.APP.MANUFACTORY.MATERIALS.ADD_iTEM.DEFAULT)
  }
            ...
            <List
              ...
              renderRow={(data: Material, _sectionID: string | number, rowID: string | number, _rowMap?: any) => (
                ...
                >
                  <Grid>
                    <Col>
                      <MaterialItem item={data} index={Number(rowID)}
